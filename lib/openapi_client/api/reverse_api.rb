...
module OpenapiClient
  class ReverseApi
    ...
    # @param lat [Float] Latitude of the location to generate an address for.
    # @param lon [Float] Longitude of the location to generate an address for.
    # @param format [String] Format to geocode. Only JSON supported for SDKs
    # @param normalizecity [Integer] Normalizes village to city level data to city
