...
# Unit tests for OpenapiClient::DirectionsNearest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'DirectionsNearest' do
  before do
    # run before each test
    @instance = OpenapiClient::DirectionsNearest.new
  end
  ...
  describe 'test an instance of DirectionsNearest' do
    it 'should create an instance of DirectionsNearest' do
      expect(@instance).to be_instance_of(OpenapiClient::DirectionsNearest)
    end
  end
